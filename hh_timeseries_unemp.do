...
keep employed state month weights children female white years_educ age head_hh
...
* Results differ for different ages.
* Significant results for narrow age ranges -- maybe because younger or older workers are preferentially retrenched?
* Adding weights also changes the significance of the results.
reg unemployed i.c1_schoolclosing##i.children i.state i.month if mrange1 == 1 & age >= 25 & age <= 40, baselevels
reg unemployed i.c1_schoolclosing##i.children##i.female i.state i.month if mrange1 == 1 & age >= 25 & age <= 40, baselevels

* Grouping school disruptions.
* Unclear if this is right?
reg unemployed i.school_disrupted##i.children i.state i.month if mrange1 == 1 & age >= 25 & age <= 40, baselevels
reg unemployed i.school_disrupted##i.children##i.female i.state i.month if mrange1 == 1 & age >= 25 & age <= 40, baselevels

* Include individual controls.
reg unemployed school_changed i.state i.month age white years_educ if mrange1 == 1 & age >= 25 & age <= 40, baselevels
reg unemployed school_changed##i.children i.state i.month age white years_educ if mrange1 == 1 & age >= 25 & age <= 40, baselevels

reg unemployed i.c1_schoolclosing##i.children i.state i.month age white years_educ if mrange1 == 1 & age >= 25 & age <= 40, baselevels
reg unemployed i.c1_schoolclosing##i.children##i.female i.state i.month age white years_educ if mrange1 == 1 & age >= 25 & age <= 40, baselevels
reg unemployed i.school_disrupted##i.children i.state i.month age white years_educ if mrange1 == 1 & age >= 25 & age <= 40, baselevels
* Use this??
reg unemployed i.school_disrupted##i.children##i.female i.state i.month age white years_educ if mrange1 == 1 & age >= 25 & age <= 40, baselevels

* Fall.
reg unemployed i.c1_schoolclosing##i.children i.state i.month if mrange2 == 1 & age >= 25 & age <= 40, baselevels
reg unemployed i.c1_schoolclosing##i.children##i.female i.state i.month if mrange2 == 1 & age >= 25 & age <= 40, baselevels

reg unemployed i.c1_schoolclosing##i.children i.state i.month age white years_educ if mrange2 == 1 & age >= 25 & age <= 40, baselevels
reg unemployed i.c1_schoolclosing##i.children##i.female i.state i.month if mrange2 == 1 & age >= 25 & age <= 40, baselevels

reg unemployed i.school_disrupted##i.children i.state i.month age white years_educ if mrange2 == 1 & age >= 25 & age <= 40, baselevels
reg unemployed i.school_disrupted##i.children##i.female i.state i.month if mrange2 == 1 & age >= 25 & age <= 40, baselevels

* Difference in unemployment rate.
reg unemployed i.children i.state i.month age white years_educ if mrange2 == 1 & age >= 25 & age <= 40, baselevels
...
reg unemployed school_changed [aw = weights] if mrange1 == 1 & age >= 25 & age <= 54 & month != 3
* Control for fixed state differences.
reg unemployed school_changed i.state [aw = weights] if mrange1 == 1 & age >= 25 & age <= 54 & month != 3
* Control for common time effects - regression DD.
reg unemployed school_changed i.state i.month [aw = weights] if mrange1 == 1 & age >= 25 & age <= 54 & month != 3
* Compare adults with and without children.
reg unemployed school_changed##i.children i.state i.month [aw = weights] if mrange1 == 1 & age >= 25 & age <= 54 & month != 3
* Control for demographics.
reg unemployed school_changed##i.children i.state i.month age white years_educ [aw = weights] if mrange1 == 1 & age >= 25 & age <= 54 & month != 3

* Test complete in-person school closures instead.
reg unemployed school_disrupted##i.children i.state i.month age white years_educ [aw = weights] if mrange1 == 1 & age >= 25 & age <= 54 & month != 3
* Note: when mrange1 == 1, school_disrupted and school_changed are basically the same.

* Separate genders, common controls for state, etc.
reg unemployed school_changed##i.female i.state i.month [aw = weights] if mrange1 == 1 & age >= 25 & age <= 54 & month != 3
reg unemployed school_changed##i.children##i.female i.state i.month age white years_educ [aw = weights] if mrange1 == 1 & age >= 25 & age <= 54 & month != 3

* Separate for heads of households.
reg unemployed school_changed##i.head_hh i.state i.month [aw = weights] if mrange1 == 1 & age >= 25 & age <= 54 & month != 3
reg unemployed school_changed##i.children##i.head_hh i.state i.month age white years_educ [aw = weights] if mrange1 == 1 & age >= 25 & age <= 54 & month != 3
* Composition?
tabulate head_hh if mrange1 == 1 & age >= 25 & age <= 54 & month != 3
bys head_hh: tabulate unemployed if mrange1 == 1 & age >= 25 & age <= 54 & month < 3
bys head_hh: tabulate unemployed if mrange1 == 1 & age >= 25 & age <= 54 & month > 3

* Summary statistics.
bys month: summarize female children white unemployed age years_educ [aw = weights] if mrange1 == 1 & month != 3 & age >= 25 & age <= 54
bys month female: summarize unemployed [aw = weights] if mrange1 == 1 & month != 3 & age >= 25 & age <= 54
...
reg unemployed school_disrupted [aw = weights] if mrange2 == 1 & age >= 25 & age <= 54
reg unemployed school_disrupted i.state [aw = weights] if mrange2 == 1 & age >= 25 & age <= 54
* Regression DD in the fall.
reg unemployed school_disrupted i.state i.month [aw = weights] if mrange2 == 1 & age >= 25 & age <= 54
* Compare children.
reg unemployed school_disrupted##i.children i.state i.month [aw = weights] if mrange2 == 1 & age >= 25 & age <= 54
reg unemployed school_disrupted##i.children i.state i.month age white years_educ [aw = weights] if mrange2 == 1 & age >= 25 & age <= 54
